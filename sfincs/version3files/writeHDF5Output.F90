...
contains
  ...
  subroutine initializeOutputFile()
    ...
    if (masterProc) then
       ...
       !! MFM - 07/31/18 - added in by michael c, removed parameters only relevant to QH
       ...
       call writeHDF5Field("symm_type", symm_type, "Scaling of non-quasisymmetric modes for (0) QA (1) QH equilibria")
